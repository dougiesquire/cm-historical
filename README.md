...
We currently have no such baseline for the CAFE forecast, which makes skill assessment difficult to interpret. In this repo, I try to explore details of the f6 forecast runs to develop a quick approach for running such a baseline.
